...
subtitle: "English Mix｜Design Literacy #64｜Designing how far an identity may bend"
created: "2026-09-21"
updated: "2026-09-21"
type: "English Mix"
status: "完成"
...
You followed the brand guidelines perfectly.

ロゴ位置も合っている。指定書体も使った。ブランドカラーも正しい。余白も前回と同じ。なのに、新商品も採用も年末キャンペーンも、全部「いつものやつ」に見える。

**You obeyed everything. So why does the identity feel weaker?**

前回はVisual Grammarを「同じ部品を使うことより、部品同士の関係を繰り返すこと」と捉えた。すると次の疑問が出る。文法があるなら、毎回同じ文章を書く必要はないはずだ。

The interesting question is not how to protect the brand.

> **どこまで壊しても、まだ同じブランドなのか。**

Once the question changes, a guideline stops looking like a book of prohibitions and starts looking like a map of movement.
...
The number became looser, yet the rule became more precise.
...
This is where the numbers become slightly absurd.

If all 4,000 posters had been the same template, that would be impressive in a rather alarming way.
...
They cannot all share one layout.
...
This is where the stress test gets interesting.
...
If utility comes first, put **decisionability** before search.
...
If brand expression reduces readability, the system has defeated its own purpose.
...
Before the research, the obvious answer seemed to be: give designers more freedom.

That was too simple.

More freedom alone can simply dissolve the identity.
...
So the next time you open a guideline, “What must I protect?” is not enough.
