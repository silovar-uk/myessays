...
subtitle: "English Mix｜Design Literacy #70｜Separate what a color means from what it looks like"
created: "2026-09-23"
updated: "2026-09-23"
type: "English Mix"
status: "完成"
...
The primary button is red.

Errors are red.

Delete is red.

Selected states are red.

At this point, red has too many jobs.
...
Today the question goes one level deeper.

> **そもそも「赤」を先に決めるから、意味が衝突するのではないか。**

Think about color by its job before its hue.
...
But six months later, the design decision is missing.
...
**The point is separating value from role.**
...
**We did not separate colors. We separated reasons for change.**
...
If the values are identical, one token seems cleaner.
...
This is not an argument for needless duplication.

**It is about distinguishing same value from same meaning.**
...
One familiar audit is to view the interface in grayscale.

Try another.

**Ban color names for 30 seconds.**
...
Instead of removing color, remove the color name and inspect the job.
...
Merging them because they match today optimizes for the present.

One looks only at current appearance.

Separating roles plans for future change.

The other preserves independent reasons to change.
...
The second question is especially useful.

## 11. 調べる前と後｜赤を選んでいたつもりが、意味の境界線を引いていた

At first, this looked like a color problem.
...
The research moved the decision upstream.
...
> **Semantic color separates what a color means from what a color looks like.**

Red starts to look different.
...
A color palette starts to look less like a box of swatches and more like a map of design decisions.
