...
subtitle: "English Mix｜Design Literacy #62｜Constraints move where freedom is spent"
created: "2026-09-20"
updated: "2026-09-20"
type: "English Mix"
status: "完成"
...
You are free to make the corner radius 11px. 12px is legal. So is 13px. Nobody stops you. CSS certainly does not.

**But is that freedom?**

前回、Design Tokenを「毎回考え直さなくていい判断を作る仕組み」として見た。すると次の疑問が出る。fontも色もspacingもradiusも決めてしまったら、デザイナーは何をデザインするのか。

At first, constraint and creativity looked like opposite ends of a rope. The research changed that picture.
...
Did creativity suddenly shrink from 3,200,000 to 972? Probably not.
...
The opposite of constraint is not necessarily creativity. It may simply be **an unedited field of choices**.
...
Expression has not disappeared. **We chose which variables are allowed to carry expression.**
...
We started with a 13px corner radius and somehow ended up discussing the profession of design.
...
A system with more rules is not automatically a more mature system.
...
Not everything needs to stay open. Not everything needs to be fixed.
...
The point was never to ban 13px.

The point was to decide whether 13px deserves human attention in the first place.
