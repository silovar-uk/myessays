...
subtitle: "Design Literacy #61｜Spacing ScaleからDesign Tokenを「判断のインフラ」として読む"
created: "2026-09-19"
updated: "2026-09-20"
type: "Essay"
status: "完成"
...
CSSは13pxを怒らない。17pxでも23pxでも、ブラウザは黙って働く。
...
数字そのものより、**意味のある限定されたscaleを共有すること**が共通している。
...
一枚ずつなら小さな差でも、100画面ではdecision driftになる。

ここで減るのは余白ではない。**余白について発生する判断の種類**だ。
...
Design Tokenを調べる前、8pxは「守る数字」に見えた。

調べた後は違う。8pxそのものが偉いわけではない。5pxでもsystemは作れる。
