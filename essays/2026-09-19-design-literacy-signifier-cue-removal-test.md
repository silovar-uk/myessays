...
subtitle: "Design Literacy #57｜Affordanceの復習ではなく、Signifierを分解して壊してみる"
created: "2026-09-19"
updated: "2026-09-19"
type: "Essay"
status: "完成"
...
## Design Literacy #57｜Affordanceの復習ではなく、Signifierを分解して壊してみる
...
技術的には最後までclickableにできる。なのに、人間から見ると途中で「操作」が消える。
...
> **「もっとボタンっぽく」ではなく、どの系統のsignifierが不足しているかを見る**
...
静止画一枚の「ボタンっぽさ」だけを見ていると、interaction designの半分しか見えていない。
